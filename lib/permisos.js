...
// Reordenar los grupos del tablero arrastrándolos: reservado a Super Admin, para que el
// orden del tablero no se desarme por accidente entre todo el equipo.
export function tienePermisoReordenarGrupos(usuario) {
  return tieneAlguno(usuario, ['SuperAdmin']);
}
